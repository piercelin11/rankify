...
export type ButtonProps = {
	variant: "lime" | "gray" | "darkGray" | "outline" | "transparent" | "menu";
	rounded?: boolean;
...
const styles = {
	...
	menu: {
		default: "w-full text-lg bg-transparent text-zinc-300 hover:text-zinc-100 hover:bg-zinc-900 justify-center lg:justify-normal",
		disabled: "w-full text-lg bg-transparent text-zinc-300 justify-center lg:justify-normal",
	}
};
